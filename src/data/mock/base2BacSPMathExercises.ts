...
const make = (id: string, chapter: string, topic: string, title: string, statement: string, answer: string, correction: string, hint: string, difficulty: 1 | 2 | 3, minutes: number): Exercise => ({ id, mode: "BASE", source: "APPROVED", target: target(chapter, topic), type: "calculation", difficulty, title, statement, expectedAnswer: answer, acceptedAnswers: [answer], correction, hint, examTip: "Présente la méthode avant l'application et garde les unités cohérentes.", estimatedMinutes: minutes, xpValue: difficulty * 7 + 5, tags: ["2BAC SP", chapter.toLowerCase()] });
...
export const base2BacSPMathExercises: Exercise[] = [
  ...
  make("sp-math-derivation-01", "Dérivation et étude des fonctions", "Tangente", "Tangente en 1", "Pour f(x)=x²+2x−1, déterminer l'équation de la tangente en x=1.", "y=4x−2", "f'(x)=2x+2, donc f'(1)=4 et f(1)=1+2−1=2. L'équation est y=2+4(x−1)=4x−2.", "Calcule f(1) puis f'(1) séparément.", 2, 3),
  ...
  make("sp-math-primitives-01", "Fonctions primitives et calcul intégral", "Intégrale", "Intégrale d'un polynôme", "Calculer ∫₀² (2x+1) dx.", "6", "Une primitive est x²+x. Donc [x²+x]₀²=6.", "Cherche une primitive simple.", 1, 2),
