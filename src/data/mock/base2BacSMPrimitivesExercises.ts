...
export const base2BacSMPrimitivesExercises: Exercise[] = [
  ...
  make("sm-prim-02", "Unicité", "Condition initiale", "Déterminer la primitive F de f(x)=4x³−3x²+2 qui vérifie F(1)=4.", "F(x)=x⁴−x³+2x−?", "Une primitive générale est F(x)=x⁴−x³+2x+C. La condition F(1)=4 donne 1−1+2+C=4, donc C=2. Ainsi F(x)=x⁴−x³+2x+2.", "Trouve d'abord la constante avec F(1)=4.", 2, 4, "multi-step"),
  ...
  make("sm-prim-12", "Synthèse", "Primitive avec condition", "Déterminer F telle que F'(x)=1/x² sur ]0,+∞[ et F(1)=3.", "F(x)=3−1/x", "Une primitive de x⁻² est −x⁻¹+C, soit F(x)=−1/x+C. Comme F(1)=3, C=4. Donc F(x)=4−1/x.", "Intègre x⁻² comme une puissance.", 2, 4, "multi-step"),
];
