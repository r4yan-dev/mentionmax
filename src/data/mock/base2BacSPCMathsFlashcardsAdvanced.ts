...
[313,"XII. Transformations complexes","Translation de vecteur u ?","z'=z+u."],[314,"XII. Transformations complexes","Rotation de centre ω et angle θ ?","z'=(z-ω)e^{iθ}+ω."],[315,"XII. Transformations complexes","Homothétie de centre ω et rapport k ?","z'=k(z-ω)+ω."],[316,"XII. Transformations complexes","Rotation de centre O ?","z'=e^{iθ}z."],[317,"XII. Transformations complexes","Homothétie de centre O ?","z'=kz."],[318,"XII. Transformations complexes","Nature de z'=z-3i ?","Translation de vecteur -3i."],[319,"XII. Transformations complexes","Nature de z'=4z-3i ?","Homothétie de rapport 4 autour de son point fixe."],[320,"XII. Transformations complexes","Comment trouver le point fixe de z'=az+b ?","Résoudre z=az+b."],[321,"XII. Transformations complexes","Point fixe de z'=-iz+i-1 ?","Résoudre z=-iz+i-1, donc z=(1+i)/2."],[322,"XII. Transformations complexes","Image par une rotation ?","Appliquer z'=(z-ω)e^{iθ}+ω."],[323,"XII. Transformations complexes","Rotation inverse ?","z-ω=(z'-ω)e^{-iθ}."],[324,"XII. Transformations complexes","Une rotation conserve quoi ?","Distances, longueurs et angles."],[325,"XII. Transformations complexes","Une homothétie de rapport k transforme une longueur L en ?","|k|L."],[326,"XII. Transformations complexes","Effet de k<0 ?","Le point image est de l'autre côté du centre."],[327,"XII. Transformations complexes","Critère pratique d'un carré ?","Deux côtés consécutifs de même longueur et perpendiculaires."],[328,"XII. Transformations complexes","Critère d'un triangle équilatéral ?","(zB-zA)/(zC-zA)=e^{±iπ/3}."],[329,"XII. Transformations complexes","Critère d'un triangle isocèle rectangle ?","Le rapport de deux côtés adjacents a un argument ±π/2 et un module approprié."],[330,"XII. Transformations complexes","Critère d'alignement ?","(zB-zA)/(zC-zA)∈R."],[331,"XII. Transformations complexes","Que représente |z-zA|=r ?","Le cercle de centre A et de rayon r."],[332,"XII. Transformations complexes","Que représente |z-zA|=|z-zB| ?","La médiatrice de [AB]."],[333,"XII. Transformations complexes","(z'-ω)/(z-ω)=e^{iθ} signifie ?","Rotation de centre ω et angle θ."],[334,"XII. Transformations complexes","Argument du rapport de deux vecteurs ?","Un angle orienté entre les directions."],[335,"XII. Transformations complexes","Comment traiter une cocyclicité avec les complexes ?","Utiliser un rapport de complexes dont l'argument caractérise les angles, ou ramener les affixes au cercle."],[336,"XII. Transformations complexes","Géométriquement, que représente z̄ ?","La symétrie axiale par rapport à l'axe réel."],[337,"XII. Transformations complexes","|z-zA| représente ?","La distance AM."],[338,"XII. Transformations complexes","|z-2i|=2 : centre et rayon ?","Centre d'affixe 2i, rayon 2."],[339,"XII. Transformations complexes","Dans z'=az+b, quoi regarder en premier ?","Le module et l'argument de a, puis le point fixe."],
