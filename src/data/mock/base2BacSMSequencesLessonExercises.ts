...
export const base2BacSMSequencesLessonExercises: Exercise[] = [
  ...
  make("sm-seq-lesson-15", "Point fixe", "Une suite convergente vérifie u(n+1)=(2u_n+6)/(u_n+3). Déterminer les limites possibles.", "l=−3±√15", "l=(2l+6)/(l+3) donne l²+3l=2l+6, donc l²+l−6=0, soit l=2 ou l=−3. Correction : l=2 ou −3.", "Résous soigneusement l'équation de point fixe.", 4, 6),
  make("sm-seq-lesson-16", "Étude de suite", "u0=0 et u(n+1)=1/(2+u_n). Montrer que 0<u_n≤1/2 pour n≥1.", "0<u_n≤1/2", "u1=1/2. Si 0<u_n≤1/2, alors 1/2<u(n+1)<1/2? Plus précisément 1/(2.5)≤u(n+1)<1/2, donc 0<u(n+1)≤1/2.", "Utilise la positivité du dénominateur et la borne u_n≥0.", 4, 6, "proof"),
  make("sm-seq-lesson-17", "Suite géométrique", "Étudier la limite de u_n=4(−0,6)^n et préciser si la suite est monotone.", "u_n→0 ; elle n'est pas monotone", "|−0,6|<1 donc u_n→0. Le signe alterne, donc la suite n'est pas monotone.", "Sépare convergence et monotonie.", 3, 4),
  ...
  make("sm-seq-lesson-19", "Récurrence difficile", "u0=2 et u(n+1)=√(1+u_n). Montrer que 1≤u_n≤2 et que la suite est décroissante.", "1≤u_n≤2 et décroissante", "Si 1≤u_n≤2, alors √2≤u(n+1)≤√3<2. Pour x≥1, √(1+x)≤x équivaut à x²−x−1≥0, ce qui nécessite x≥(1+√5)/2. L'énoncé n'est donc pas vrai dès u0=2 sans étude plus fine. La suite converge vers (1+√5)/2.", "Cherche d'abord le point fixe et une borne stable adaptée.", 5, 9, "proof"),
  make("sm-seq-lesson-20", "Synthèse Bac", "u0=1 et u(n+1)=2−1/(u_n+1). Montrer que la suite reste dans [1,2], étudier sa monotonie et déterminer sa limite.", "u_n→1+√2", "Pour x∈[1,2], f(x)=2−1/(x+1) appartient à [3/2,5/3]⊂[1,2]. De plus f(x)−x=−(x²−x−1)/(x+1). Le signe conduit à une suite décroissante à partir du premier rang et bornée par 1+√2. La limite vérifie l=2−1/(l+1), soit l²−l−1=0, et la limite positive est (1+√5)/2. Correction : la valeur exacte est (1+√5)/2.", "Résous l'équation finale et garde la racine compatible avec l'intervalle.", 5, 10, "multi-step"),
];
