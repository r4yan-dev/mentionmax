...
export default function FocusExercise(){
  ...
  return <main className="focus-exercise-page"><div className="focus-exercise-shell">
    ...
    <section className="focus-question-card"><div className="focus-question-meta"><span><Sparkles size={14}/> EXERCICE</span><span><Clock3 size={14}/> {exercise.estimatedMinutes} min</span></div><span className="section-eyebrow">{exercise.target.chapter} · {exercise.target.topic}</span><h1>{exercise.title}</h1><div className="focus-context-box"><span className="section-eyebrow">ÉNONCÉ</span><LatexText>{exercise.statement}</LatexText><ExerciseVisual visual={exercise.visual}/></div><div className="focus-objective-box"><Target size={17}/><div><span>Objectif</span><strong>Résoudre, justifier et rédiger proprement.</strong></div></div>
